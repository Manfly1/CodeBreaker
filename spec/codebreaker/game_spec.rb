...
RSpec.describe Codebreaker::Game do
  ...
  describe "#game" do
    ...
    context "player makes a valid guess" do
    ...
    context "player makes an invalid guess" do
    ...
    context "player makes a right guess" do
